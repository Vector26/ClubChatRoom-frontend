...
export const Home = () => {
  ...
  return <>
        <MsgBox>
            ...
            <Typography variant="body2" align='center'>We’re working hard to get Codershouse ready for everyone! While we wrap up the finishing youches, we’re adding people gradually to make sure nothing breaks :)</Typography>
